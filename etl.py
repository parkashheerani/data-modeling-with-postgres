...
def expand_time_data(df, ts_field):
    ...
    t['weekday_name'] = t['datetime'].dt.weekday
    t['week'] = t['datetime'].dt.week.isocalendar().week
...
def main():
    ...
    conn = psycopg2.connect("host=127.0.0.1 dbname=sparkifydb user=postgres password=12345")
    cur = conn.cursor()
